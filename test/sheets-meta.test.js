...
test("grade dá sala e professor por dia e horário", () => {
	...
	assert.deepEqual(grade.get("2|07:30"), { subject: "ExtPes", room: "D04", teacher: "Leila L Rossi" });
	assert.deepEqual(grade.get("2|10:20"), { subject: "DWeb-I", room: "D04", teacher: "Fabricio Bizotto" });
});
